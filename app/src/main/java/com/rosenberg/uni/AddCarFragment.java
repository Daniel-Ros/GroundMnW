...
public class AddCarFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Spinner make  = view.findViewById(R.id.add_car_make);
        Spinner model  = view.findViewById(R.id.add_car_model);
        EditText mileage = view.findViewById(R.id.add_car_mileage);
        Button done = view.findViewById(R.id.add_car_done);
        ...
        model.setAdapter(adapterModel);
            ...
            Car car = new Car(make.getSelectedItem().toString(),model.getSelectedItem().toString(),uid);
