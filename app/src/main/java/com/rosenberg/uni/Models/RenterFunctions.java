...
public class RenterFunctions {
     ...
     * @param end same
     * @param renterCarViewFragment as named
     */
    public void filterSearch(String start, String end, RenterCarViewFragment renterCarViewFragment){
        ...
        _fs.collection("cars")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    renterCarViewFragment.refreshCars(cars, renterCarViewFragment.carsView);
                });
    }
